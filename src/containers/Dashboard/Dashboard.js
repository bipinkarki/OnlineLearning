      ...
      <Box my={5} style={{ minHeight: 520 }}>
        <Box mx={6} py={3}>
          <Typography variant="h5" gutterBottom>
            <strong>Go ahead. Get an Intership !</strong>
          </Typography>
          <Typography variant="subtitle1" gutterBottom>
            Here are some latest opportunities.Apply to  internships for free.
          </Typography>
        </Box>
        <CourseList />
      </Box>
          ...
          <Box alignSelf="flex-start" maxWidth={500} m={5}>
            <Box display="flex">
              ...
              <Box ml={1} display="flex" flexDirection="column">
                ...
                <Typography style={{ marginTop: 16 }}>
                  InternMandu system is meticulously built to enhance the
                  interaction between Interns and company. It provides an
                  authentic and easy experience to gain knowledge to upgrade the skills.
                </Typography>
              </Box>
            </Box>
          </Box>
